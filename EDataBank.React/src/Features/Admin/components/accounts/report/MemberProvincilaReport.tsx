...
import ProvincialMemberReportQueryDialog from "./ProvincialMemberReportQueryDialog";
  ...
  const MemberProvincilaReport = (props: Props) => {
              ...
              items={[
                {
                  ...
                  onClick: (
                    ...
                    //AdminStore.provincialMemberReport(Number(AdminStore.provinceValueForRefresh),AdminStore.genderValueForRefresh);
                  },
                },
        ...
        <div className="ms-Grid-row" style={{ paddingTop: "10px" }}>
          <div className="ms-Grid-col ms-sm12">
            <MessageBar messageBarType={MessageBarType.warning}>
              <b style={{color:"#d92525"}}>Note</b>:This report is generated from <b>{AdminStore.selectedGender}</b> member information in <b>{AdminStore.selectedProvince}</b> Province at CMC <b>{AdminStore.selectedCmc}</b>.
            </MessageBar>
          </div>
        </div>
        )}
  ...
  export default observer(MemberProvincilaReport);
