...
//   
  ...
  return (
    <DialogEx
      hidden={!AdminStore.openQueryReportDialog}
      onDismiss={() => {}}
      dialogContentProps={{
        type: DialogType.largeHeader,
        title: `Member Report query Dialog`,
     ...
     <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          try {
            ...
            await AdminStore.memberReport(Number(values.branchId),values.gender);   
            AdminStore.openQueryReportDialog = false;
          } catch (error: any) {
            notification.error({
                  ...
                  <Form.Item label="Branch"  help={touched.branchId || errors.branchId} required>
                    <Select
                        ...
                        onChange={(val, opt: any) => {
                            ...
                            AdminStore.branchValueForRefresh = val
                  ...
                  <Observer>
                      ...
                      <Form.Item
                        ...
                        <Segmented
                          ...
                          value={AdminStore.genderValue}                 
                          onChange={(value: SegmentedValue) => {
                            setFieldValue("gender", value);
                            AdminStore.genderValue = String(value)
                            AdminStore.genderValueForRefresh = String(value)
