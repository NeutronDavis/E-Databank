...
import { IRank } from "../../../../Admin/types/interface";
...
function OrdinationEditDialog() {
  ...
  return (
    <Modal
        open={MemberOrdinationStore.showEditDialog}
        // width={"20%"}
        title= {`Edit Ordination`}
        onCancel={() => {
            MemberOrdinationStore.showEditDialog= false;
    ...
    >
     ...
     <Formik
        initialValues={MemberOrdinationStore.selectedOrdination}
...
export default observer(OrdinationEditDialog);
