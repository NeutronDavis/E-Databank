...
namespace EDataBank.Database.Migrations
{
    ...
    [Migration("20240620095937_errorLogInnerExceptionMessage")]
    partial class errorLogInnerExceptionMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EDataBank.Core.Entity.Error.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("EDataBank.Core.Entity.Report.GeneralReportModel", b =>
                {
                    ...
                    b.Property<int?>("CurrentRankOrder")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EDataBank.Core.Entity.Report.General_Report_Model2", b =>
                {
                    b.Property<string>("Address")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("generalprovincialmemberview", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("EDataBank.Core.Entity.Report.UploadInfo", b =>
                {
                    b.Property<int>("UploadInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UploadInfoId"));
            ...
            modelBuilder.Entity("EDataBank.Core.Views.OrdinationProgressionView", b =>
                {
                    b.Property<int?>("BranchId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("YearsFromNow")
                        .HasColumnType("int");

                    b.ToTable("HighestYearOrdinationsWithAge", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("EDataBank.Core.Views.UploadInfoView", b =>
                {
                    b.Property<int?>("BranchId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("uploadinfo_vw", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
